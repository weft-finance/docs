...
The Vayu API is slim and focused: it is for logging in and for sending events. With just two lines of code, your company can begin billing for metered events at scale.
