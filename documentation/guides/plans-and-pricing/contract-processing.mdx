...
**Renewal with new terms** - renewal of contract for a new period with updated pricing terms.

**Update** **of the current contract** - update a contract with additional products, prices and discounts. In this case you’ll be able to update the contract terms Retroactive or for future updates and issue invoices according to the updated terms
