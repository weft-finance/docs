...
**Base Fee** – A minimum charge applied to a usage product when consumption or below a set floor.
...
**Discount** – A price reduction applied at the line-item or plan level (can be One-Time or Recurring Discount)
...
- _Examples:_ One-Time Fee, Subscription
