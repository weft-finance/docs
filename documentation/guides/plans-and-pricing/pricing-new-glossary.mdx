...
**Auto-pgrade** – When a customer crosses a usage tier into a new tier, that customer is automatically upgraded to the new tier permanently
...
**Bulk Fee** – A pricing option where a single rate applies to a set v.
